...
%% FIGURE 8 - Impact of release frequency on transient dynamics with low (default) predator mortality
disp("Computing and plotting Figure 8 - impact of release frequency on transient dynamics with low predator mortality");
...
fig8=figure(8);
clf(fig8);
set(fig8,'Units','centimeters','Position',[0,0,30,13],'PaperUnits','centimeters','PaperSize',[30,13]*1.05);


%% FIGURE 8 (a) - stability regions
...
text(2300,1.1,'\bf Stable','Color','k','Interpreter','latex')
legend('$m=1$','$m=2$','$m=5$','$m=50$','$(3000, 0.8)$','Interpreter','latex');


%% FIGURE 8 (b) - [I,B] dynamics
